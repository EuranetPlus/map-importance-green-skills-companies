export const config = {
	mapTitle: 'map-importance-green-skills-companies', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-importance-green-skills-companies.vercel.app/', // The url provided when deploying the map on Vercel
	...
	colourScheme: 'orange-red', // one of the following: "blue", "purple-blue", "green-blue", "orange-red", "yellow-green"
